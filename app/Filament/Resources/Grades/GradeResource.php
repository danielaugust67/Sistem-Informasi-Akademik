...
class GradeResource extends Resource
{
    ...
    protected static \UnitEnum|string|null $navigationGroup = 'Perkuliahan & KBM';
    protected static ?string $modelLabel = 'Rapor & Nilai Akhir';
    protected static ?string $pluralModelLabel = 'Rapor & Nilai Akhir';
